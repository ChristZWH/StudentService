...
func newStudent(db *gorm.DB, opts ...gen.DOOption) student {
	...
	_student.ID = field.NewString(tableName, "id")
	_student.Name = field.NewString(tableName, "name")
	_student.Tel = field.NewString(tableName, "tel")
	_student.Study = field.NewString(tableName, "study")
...
func (s *student) updateTableName(table string) *student {
	...
	s.Study = field.NewString(table, "study")
